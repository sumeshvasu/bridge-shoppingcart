...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
   	...
   	include_once 'controller/paypal-controller.php';  // include the class file
   	$paypal = new PaypalController;             // initiate an instance of the class
      ...
      //$paypal->add_field('return', $this_script.'?page=paypal&action=success');
      $paypal->add_field('return', 'http://localhost/bridge-store/templates/checkout.php?action=success');
      $paypal->add_field('cancel_return', 'http://localhost/bridge-store/templates/checkout.php?action=cancel');
      $paypal->add_field('notify_url', 'http://localhost/bridge-store/templates/checkout.php?action=ipn');
