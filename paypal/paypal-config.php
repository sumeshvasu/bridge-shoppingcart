...
$PayPalReturnURL 		= 'http://localhost/bridge-store/paypal/process.php'; //Point to process.php page
$PayPalCancelURL 		= 'http://localhost/bridge-store/paypal/cancel_url.php'; //Cancel URL if user clicks cancel
?>