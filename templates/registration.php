			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-7">
							<div class="form-group">
								<input autofocus required="required" class="form-control" placeholder="Enter First name" name="firstname" value="<?php if( isset( $post['firstname']) && $post['firstname'] != '' ){ echo $post['firstname']; }?>">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
						...
						<div class="col-xs-7">
							<div class="form-group">
								<input class="form-control" placeholder="Enter Last name" name="lastname" value="<?php if( isset( $post['lastname']) && $post['lastname'] != '' ){ echo $post['lastname']; }?>">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
						...
						<div class="col-xs-7">
							<div class="form-group">
								<input type="email" class="form-control" placeholder="Enter Email" name="email" value="<?php if( isset( $post['email']) && $post['email'] != '' ){ echo $post['email']; }?>">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
						...
						<div class="col-xs-7">
							<div class="form-group">
								<input required="required" class="form-control" placeholder="Enter Username" name="username" value="<?php if( isset( $post['username']) && $post['username'] != '' ){ echo $post['username']; }?>">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
